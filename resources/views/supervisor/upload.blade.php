...
@endif
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title" style="color:white;font-size:x-large">Add Products</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{route('supitem')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  name="assetcode" id="" required>
                                        <span class="text-danger">
                                            @error('assetcode')
                                            {{$message}}
                                            @enderror
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  name="depart" id="">
                                    </div>
                                </div>
									...
									<div class="form-group">
										...
										<div class="profile-upload">
											...
											<div class="upload-input">
												<input type="file" class="form-control" accept=".png, .jpg, .jpeg"  name="image" id="" required>
                                                <span class="text-danger">
                                            @error('image')
                                            {{$message}}
                                            @enderror
							...
							<div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="des" id="" cols="30" maxlength="100""></textarea>
                            </div>
                            <div class="form-group">
