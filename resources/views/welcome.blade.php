...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">Indus Valley School of Art and Architecture (IVS) </a>
  ...
  <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline btn btn-outline-success my-2 my-sm-0" style="margin-left: 55rem !important;">Log in</a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <figure class="figure" style="width:350px;height:390px ">
            ...
            <figcaption class="figure-caption text-center">
              ...
              <p>
              <button onclick='location.href="{{ route('login') }}"'class="btn primary">Add To Acquire</button>
              </p>
            </figcaption>
          </figure>
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2023 Copyright:
    <a class="text-reset fw-bold" href="">Salafi</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
