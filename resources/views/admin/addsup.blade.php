...
@endif
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{route('affixsup')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  required name="department" id="">
                                        <span class="text-danger">
                                            @error('department')
                                            {{$message}}
                                            @enderror
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Create Superviosr</button>
                            </div>
                        </form>
                    </div>
                </div>
